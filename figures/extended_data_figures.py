...
def _ext_fig1_global_phase_diagram(output_dir: str, fmt: str, dpi: int) -> str:
    ...
    ax_l.plot(alphas, e_0 / 0.35,           color="#d62728",
    ...
    ax_r.fill_between(q, E, alpha=0.25, color="#1f77b4")
    ax_r.plot(q, E, color="#1f77b4", lw=1.8)
    ...
    fig.suptitle("Global Phase Diagram and Landscape Fragmentation",
                 fontsize=11, y=1.01)
    fig.tight_layout()
...
def _ext_fig2_fss_hardness_peak(
    ...
    fig.suptitle("Finite-Size Scaling and Hardness Peak",
                 fontsize=11, y=1.01)
    fig.tight_layout()
...
def _ext_fig5_runtime_distribution(output_dir: str, fmt: str, dpi: int) -> str:
    ...
    ax_l.hist(log_t, bins=50, density=True, alpha=0.6, color="#1f77b4",
    ...
    ax_l.plot(x_fit, pdf_ln, color="#d62728",
    ...
    ax_l.plot(x_tail, pdf_tail, color="#ff7f0e",
    ...
    ax_r.semilogy(t_fit, S_fit + 1e-4, color="#d62728",
    ...
    fig.suptitle("Runtime Distribution at Criticality",
                 fontsize=11, y=1.01)
    fig.tight_layout()
...
def _ext_fig6_theoretical_phase_diagram(output_dir: str, fmt: str, dpi: int) -> str:
    ...
    ax1.plot(alphas, e_0,  color="#d62728",
    ...
    for val, lab in [
        ...
        (ALPHA_C, r"$\alpha_c \approx 4.267$"),
    ...
    ax1.set_title(
        r"Theoretical Phase Diagram — $e_0$, $e_\mathrm{th}$, and $\Sigma$ vs $\alpha$"
    )
...
def _ext_fig7_runtime_statistics(output_dir: str, fmt: str, dpi: int) -> str:
    ...
    ax_l.hist(t_ref, bins=bin_edges, density=True, alpha=0.6, color="#1f77b4",
    ...
    ax_l.plot(t_fit, pdf_overlay, color="#d62728",
    ...
    fig.suptitle("Runtime Distribution Statistics at Criticality",
                 fontsize=11, y=1.01)
    fig.tight_layout()
