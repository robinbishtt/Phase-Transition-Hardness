.PHONY: help install install-dev test test-unit test-integration test-validation test-all lint format clean reproduce reproduce-quick tables docker-build docker-run docs
...
reproduce:
	bash reproduce.sh --output=results

reproduce-quick:
	bash reproduce.sh --quick --output=results_quick
