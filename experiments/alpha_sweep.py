...
def main():
    ...
    # The experiment itself succeeded regardless of how many downstream-dependent
    # validation checks pass at this point.  Checks that depend on outputs from
    # subsequent experiments (e.g. fss_result.json from finite_size_scaling.py)
    # are expected to be incomplete here; the authoritative validation runs via
    # src/validation.py after all experiments have completed.
    return 0
